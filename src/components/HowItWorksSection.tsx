    ...
    <section className="py-24 px-6 relative overflow-hidden">
      <div className="container mx-auto max-w-7xl relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8 relative">
          {/* Connection line */}
          <motion.div 
            className="hidden md:block absolute top-24 left-1/6 right-1/6 h-px bg-gradient-to-r from-transparent via-fresh/30 to-transparent"
            initial={{ scaleX: 0 }}
        ...
        <motion.div 
          className="mt-20 p-8 rounded-3xl bg-card border border-border"
          initial={{ opacity: 0, y: 40 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: "-50px" }}
